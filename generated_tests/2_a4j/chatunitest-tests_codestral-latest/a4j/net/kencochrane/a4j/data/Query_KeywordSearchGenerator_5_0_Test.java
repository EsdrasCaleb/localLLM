...
public class Query_KeywordSearchGenerator_5_0_Test {
    ...
    public void testKeywordSearchGenerator() throws Exception {
        ...
        String expectedURL = "http://example.com?t=testAssociatesID&dev-t=DSB0XDDW1GQ3S&KeywordSearch=encodedSearchTerm&mode=testProductLine&type=testType&page=1&f=xml";
