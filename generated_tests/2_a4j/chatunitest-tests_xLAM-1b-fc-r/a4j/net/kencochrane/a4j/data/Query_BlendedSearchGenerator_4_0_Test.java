...
public class Query_BlendedSearchGenerator_4_0_Test {
    ...
    public void testBlendedSearchGenerator() throws Exception {
        ...
        Field field9 = Query.class.getDeclaredField("jawsUtil");
        field9.setAccessible(true);
        field9.set(query, Mockito.mock(a4jUtil.class));
        String result = query.BlendedSearchGenerator("image", "example");
        assertEquals("http://example.com?t=12345&dev-t=ABCDEF&BlendedSearch=example&type=image&f=xml", result);
    }
}
