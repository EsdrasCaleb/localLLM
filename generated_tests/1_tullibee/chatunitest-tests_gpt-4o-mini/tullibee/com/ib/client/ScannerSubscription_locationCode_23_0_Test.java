...
public class ScannerSubscription_locationCode_23_0_Test {
    ...
    @Test
    public void testLocationCode_setsLocationCode() throws NoSuchFieldException, IllegalAccessException {
        // Arrange
        String expectedLocationCode = "US-NY";
        // Act
    ...
    @Test
    public void testLocationCode_setsNullLocationCode() throws NoSuchFieldException, IllegalAccessException {
        // Arrange
