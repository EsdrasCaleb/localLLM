...
public class TickType_getField_0_0_Test {
    ...
    public void testGetField() {
        ...
        assertEquals("closeEFP", TickType.getField(TickType.CLOSE_EFP_COMPUTATION));
        assertEquals("lastTimestamp", TickType.getField(TickType.LAST_TIMESTAMP));
        assertEquals("shortable", TickType.getField(TickType.SHORTABLE));
        assertEquals("fundamentals", TickType.getField(TickType.FUNDAMENTAL_RATIOS));
        assertEquals("RTVolume", TickType.getField(TickType.RT_VOLUME));
        assertEquals("halted", TickType.getField(TickType.HALTED));
        // Test for an unknown tickType
        assertEquals("unknown", TickType.getField(-1));
        // Test for another unknown tickType
